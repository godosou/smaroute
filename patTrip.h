...
public:
  patTrip(patNetwork* network,vector< list <  pair<patArc*,patULong> > >* theAdjList) ;

  void newTrip(patULong theUserId,
		  patULong theTripId,
...
void connectPoints(patULong endNodeId,patULong hierarchy,list<list<patULong> >* pathTemp) ;
