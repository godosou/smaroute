...
#include "patShortestPathAlgoRangeSimpleOrig.h"
...
patShortestPathAlgoRangeSimpleOrig::patShortestPathAlgoRangeSimpleOrig(vector< list <  pair<patArc*,unsigned long> > >* adjList, patNetwork* theNetwork,	double aMinimumLabel
...
bool patShortestPathAlgoRangeSimpleOrig::computeShortestPathTree(set<unsigned long> theRoot,
double ceil ) {
