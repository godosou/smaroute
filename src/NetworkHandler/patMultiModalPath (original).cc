...
patMultiModalPath::patMultiModalPath(const patMultiModalPath& other):
			m_roads (m_roads),
			 m_unique_modes(m_unique_modes),
			 m_od(m_od),
			 m_name(m_name),
			 m_id(m_id),
			 m_attributes(m_attributes),
			 m_distance_to_stop(m_distance_to_stop){
}
...
//	DEBUG_MESSAGE("OK");
//	DEBUG_MESSAGE(aPath.getLength()<<" "<<bPath.getLength());
