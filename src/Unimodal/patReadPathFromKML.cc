...
patBoolean patReadPathFromKML::parseFile(patError*& err) {
                            ...
                            if (patString(descrip_iter->get_name()) == patString("description")) {
                                ...
                                if (desc_str == "") {
                                    ...
                                    if (regex_match(desc_str, what, rex)) {
                                        ...
                                        patULong link_id(atoi(what[1].str().c_str()));
                                        patULong up_node_id(atoi(what[2].str().c_str()));
                                        patULong down_node_id(atoi(what[3].str().c_str()));
