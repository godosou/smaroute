...
//patString fileName("workTrip.xml") ;
  ...
  */
	...
	patNode* o = theNetwork.getNodeFromUserId(patULong(393712385));
	patNode* d = theNetwork.getNodeFromUserId(patULong(269608414));
