...
patShortestPathAlgoRangeSimpleOrig::patShortestPathAlgoRangeSimpleOrig(vector< list <  pair<patArc*,patULong> > >* adjList, patNetwork* theNetwork,	patReal aMinimumLabel
...
patBoolean patShortestPathAlgoRangeSimpleOrig::computeShortestPathTree(set<patULong> theRoot,
patReal ceil ) {
