...
patShortestPathAlgoRange::patShortestPathAlgoRange(patGpsPoint* gpsPoint, vector< list < pair<patArc*, patULong> > >* adjList, patNetwork* theNetwork, patReal aMinimumLabel
